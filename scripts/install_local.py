...
if __name__=='__main__':
    ...
    subprocess.run(['ditto',str(ROOT/'.subloom/build/SubPop Probe.app'),'/Applications/SubPop Probe.app'],check=True)
    subprocess.run(['codesign','--verify','--deep','--strict','/Applications/SubPop Probe.app'],check=True)
